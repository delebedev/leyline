...
1. Install the local connection config.
   ...
   Install [app/main/resources/services.conf](/Users/denislebedev/src/leyline--steamos/app/main/resources/services.conf) as the client `StreamingAssets/services.conf`.
