 ...
 *
 * The reference client flow never offers actions during AI combat phases
 * (actionsCount=0 in GSMs, confirmed across reference runs). The fix
 * downgrades SEND_STATE to fall-through on AI turns, matching that behavior.
 *
