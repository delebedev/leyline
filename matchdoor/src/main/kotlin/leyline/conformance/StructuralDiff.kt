...
object StructuralDiff {
    ...
    /** Action kinds that must appear in actual if expected has them (structural, not deck-dependent). */
    ...
    fun compareShape(
        ...
        // If expected has a kind anywhere, actual must also have it somewhere.
