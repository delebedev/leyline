 ...
 *    (Plot, Foretell, Disturb, Escape, Jump-start, Cleave, Overload, Warp, Sneak, Madness, Flashback,
...
data class BoundCard(
    ...
    companion object {
         ...
         * (Warp/Sneak/Plot/Foretell/Disturb/Escape/Jump-start/Cleave/Overload/Madness/Flashback/Mobilize).
         */
