...
fun statsToJson(
    ...
    return buildString {
        ...
        append("\"snapshotFidelityGrades\":${mapToJson(stats.snapshotFidelityGrades)},")
        append("\"snapshotImportFindings\":${mapToJson(stats.snapshotImportFindings)},")
        append("\"snapshotDecisionSources\":${mapToJson(stats.snapshotDecisionSources)},")
        append("\"snapshotSemanticAgreement\":${mapToJson(stats.snapshotSemanticAgreement)},")
        append("\"snapshotSemanticMismatchSamples\":${stringMapToJson(stats.snapshotSemanticMismatchSamples)},")
