...
class AdventureCompanionTest :
    BoardTest({
        ...
        test("parent reallocation deletes and recreates Adventure companion") {
            ...
            val oldCompanionIid =
                board.bridge
                    .getOrAllocInstanceId(FrameIdResolver.adventureCompanionForgeId(InstanceId(oldParentIid)))
                    .value
        ...
        test("creature resolution preserves companion within parent lifetime") {
            ...
            val companionIid =
                board.bridge
                    .getOrAllocInstanceId(FrameIdResolver.adventureCompanionForgeId(InstanceId(parentIid)))
                    .value
