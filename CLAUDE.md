...
- **Changelog per PR.** Add a bullet to the `[Unreleased]` section of `CHANGELOG.md` for every user-visible change. Group under: Protocol, Engine, Launcher, Puzzles, Docs.
