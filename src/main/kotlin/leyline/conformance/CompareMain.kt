...
import leyline.recording.parseSeatFilter
import leyline.recording.printSeatIdentification
import java.io.File
...
fun main(args: Array<String>) {
    ...
    val ourDir = LeylinePaths.ENGINE_DUMP
    if (!ourDir.isDirectory) {
        println("No ${LeylinePaths.ENGINE_DUMP}/ found — run just serve first (recording is always-on)")
