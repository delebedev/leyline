...
import forge.nexus.game.AnnotationBuilder
...
private val OUR_BUILDERS: Map<String, Set<String>> by lazy {
    mapOf(
        ...
        "ManaPaid" to keysOf(AnnotationBuilder.manaPaid(1, 1, "G")),
        ...
        "ModifiedPower" to keysOf(AnnotationBuilder.modifiedPower(1, 5)),
        "ModifiedToughness" to keysOf(AnnotationBuilder.modifiedToughness(1, 3)),
