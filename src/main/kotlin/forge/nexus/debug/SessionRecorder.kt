 ...
 * - `forge` — NexusGameEvents drained from GameEventCollector
...
class SessionRecorder(
    ...
    fun recordForgeEvents(events: List<NexusGameEvent>) {
    ...
    private fun extractSeat(ev: NexusGameEvent): Int? = when (ev) {
        is NexusGameEvent.LandPlayed -> ev.seatId
        is NexusGameEvent.SpellCast -> ev.seatId
        is NexusGameEvent.AttackersDeclared -> ev.seatId
        is NexusGameEvent.BlockersDeclared -> ev.seatId
        is NexusGameEvent.CardDestroyed -> ev.seatId
        is NexusGameEvent.CardSacrificed -> ev.seatId
        is NexusGameEvent.CardBounced -> ev.seatId
        is NexusGameEvent.CardExiled -> ev.seatId
        is NexusGameEvent.CardDiscarded -> ev.seatId
        is NexusGameEvent.CardMilled -> ev.seatId
        is NexusGameEvent.SpellCountered -> ev.seatId
        is NexusGameEvent.TokenCreated -> ev.seatId
        is NexusGameEvent.LifeChanged -> ev.seatId
        is NexusGameEvent.DamageDealtToPlayer -> ev.targetSeatId
        is NexusGameEvent.LibraryShuffled -> ev.seatId
        is NexusGameEvent.Scry -> ev.seatId
        is NexusGameEvent.Surveil -> ev.seatId
        else -> null
    }
