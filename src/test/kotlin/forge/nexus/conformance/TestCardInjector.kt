...
/**
 * Injects cards into a running game and registers them in both Forge and Nexus layers.
 *
 ...
 * - Registers in [forge.nexus.game.InstanceIdRegistry] (forgeCardId → instanceId)
 *
